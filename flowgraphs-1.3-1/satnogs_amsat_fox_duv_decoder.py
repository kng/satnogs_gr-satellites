...
class satnogs_amsat_fox_duv_decoder(gr.top_block):
    ...
    def set_max_modulation_freq(self, max_modulation_freq):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.audio_samp_rate, self.max_modulation_freq, 1000, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.audio_samp_rate, self.max_modulation_freq, 1000, firdes.WIN_HAMMING, 6.76))
