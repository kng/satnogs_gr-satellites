...
class satnogs_argos_bpsk_ldr(gr.top_block):
    ...
    def get_variable_argos_ldr_decoder_0_0(self):
        return self.variable_argos_ldr_decoder_0_0

    def set_variable_argos_ldr_decoder_0_0(self, variable_argos_ldr_decoder_0_0):
        self.variable_argos_ldr_decoder_0_0 = variable_argos_ldr_decoder_0_0

    def get_variable_argos_ldr_decoder_0(self):
        return self.variable_argos_ldr_decoder_0

    def set_variable_argos_ldr_decoder_0(self, variable_argos_ldr_decoder_0):
        self.variable_argos_ldr_decoder_0 = variable_argos_ldr_decoder_0
    ...
    def set_avg_len(self, avg_len):
        ...
        self.blocks_delay_1.set_dly(self.avg_len // 2)
...
def argument_parser():
    ...
    parser.add_argument(
        "--baudrate", dest="baudrate", type=eng_float, default="800.0",
